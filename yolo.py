...
class YOLO(object):
    _defaults = {
        ...
        "model_path": 'logs_ir/loss_2024_04_12_21_47_43/ep260-loss0.473-val_loss0.299.pth',
        "classes_path"      : 'model_data/voc_classes_0.45.txt',
        #---------------------------------------------------------------------#
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        for i, c in list(enumerate(top_label)):
            ...
            # 计算文本矩形的右下角坐标
            text_end = (text_origin[0] + label_size[0], text_origin[1] + label_size[1])
            # 使用这两个坐标绘制矩形
            draw.rectangle([text_origin, text_end], fill=self.colors[c])
